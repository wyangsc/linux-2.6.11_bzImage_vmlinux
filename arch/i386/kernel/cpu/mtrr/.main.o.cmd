cmd_arch/x86_64/kernel/../../i386/kernel/cpu/mtrr/main.o := gcc -Wp,-MD,arch/x86_64/kernel/../../i386/kernel/cpu/mtrr/.main.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow      -DKBUILD_BASENAME=main -DKBUILD_MODNAME=main -c -o arch/x86_64/kernel/../../i386/kernel/cpu/mtrr/.tmp_main.o arch/x86_64/kernel/../../i386/kernel/cpu/mtrr/main.c

deps_arch/x86_64/kernel/../../i386/kernel/cpu/mtrr/main.o := \
...
arch/x86_64/kernel/../../i386/kernel/cpu/mtrr/main.o: $(deps_arch/x86_64/kernel/../../i386/kernel/cpu/mtrr/main.o)
