cmd_arch/x86_64/kernel/msr.o := gcc -Wp,-MD,arch/x86_64/kernel/.msr.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow      -DKBUILD_BASENAME=msr -DKBUILD_MODNAME=msr -c -o arch/x86_64/kernel/.tmp_msr.o arch/x86_64/kernel/msr.c

deps_arch/x86_64/kernel/msr.o := \
...
arch/x86_64/kernel/msr.o: $(deps_arch/x86_64/kernel/msr.o)
