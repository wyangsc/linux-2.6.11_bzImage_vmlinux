cmd_arch/x86_64/kernel/smpboot.o := gcc -Wp,-MD,arch/x86_64/kernel/.smpboot.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow      -DKBUILD_BASENAME=smpboot -DKBUILD_MODNAME=smpboot -c -o arch/x86_64/kernel/.tmp_smpboot.o arch/x86_64/kernel/smpboot.c

deps_arch/x86_64/kernel/smpboot.o := \
...
arch/x86_64/kernel/smpboot.o: $(deps_arch/x86_64/kernel/smpboot.o)
