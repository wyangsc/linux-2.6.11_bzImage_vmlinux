cmd_arch/x86_64/mm/k8topology.o := gcc -Wp,-MD,arch/x86_64/mm/.k8topology.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow      -DKBUILD_BASENAME=k8topology -DKBUILD_MODNAME=k8topology -c -o arch/x86_64/mm/.tmp_k8topology.o arch/x86_64/mm/k8topology.c

deps_arch/x86_64/mm/k8topology.o := \
...
arch/x86_64/mm/k8topology.o: $(deps_arch/x86_64/mm/k8topology.o)
