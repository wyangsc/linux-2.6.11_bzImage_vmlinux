cmd_arch/x86_64/pci/k8-bus.o := gcc -Wp,-MD,arch/x86_64/pci/.k8-bus.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow   -Iarch/i386/pci    -DKBUILD_BASENAME=k8_bus -DKBUILD_MODNAME=k8_bus -c -o arch/x86_64/pci/.tmp_k8-bus.o arch/x86_64/pci/k8-bus.c

deps_arch/x86_64/pci/k8-bus.o := \
...
arch/x86_64/pci/k8-bus.o: $(deps_arch/x86_64/pci/k8-bus.o)
