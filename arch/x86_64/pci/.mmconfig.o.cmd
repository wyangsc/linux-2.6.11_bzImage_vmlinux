cmd_arch/x86_64/pci/mmconfig.o := gcc -Wp,-MD,arch/x86_64/pci/.mmconfig.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow   -Iarch/i386/pci    -DKBUILD_BASENAME=mmconfig -DKBUILD_MODNAME=mmconfig -c -o arch/x86_64/pci/.tmp_mmconfig.o arch/x86_64/pci/mmconfig.c

deps_arch/x86_64/pci/mmconfig.o := \
...
arch/x86_64/pci/mmconfig.o: $(deps_arch/x86_64/pci/mmconfig.o)
