cmd_drivers/acpi/debug.o := gcc -Wp,-MD,drivers/acpi/.debug.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -Os     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow   -Os -DACPI_DEBUG_OUTPUT   -DKBUILD_BASENAME=debug -DKBUILD_MODNAME=debug -c -o drivers/acpi/.tmp_debug.o drivers/acpi/debug.c

deps_drivers/acpi/debug.o := \
...
drivers/acpi/debug.o: $(deps_drivers/acpi/debug.o)
