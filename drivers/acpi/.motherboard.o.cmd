cmd_drivers/acpi/motherboard.o := gcc -Wp,-MD,drivers/acpi/.motherboard.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow   -Os   -DKBUILD_BASENAME=motherboard -DKBUILD_MODNAME=motherboard -c -o drivers/acpi/.tmp_motherboard.o drivers/acpi/motherboard.c

deps_drivers/acpi/motherboard.o := \
...
drivers/acpi/motherboard.o: $(deps_drivers/acpi/motherboard.o)
