cmd_drivers/block/rd.mod.o := gcc -Wp,-MD,drivers/block/.rd.mod.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow      -DKBUILD_BASENAME=rd -DKBUILD_MODNAME=rd -DMODULE -c -o drivers/block/rd.mod.o drivers/block/rd.mod.c

deps_drivers/block/rd.mod.o := \
  drivers/block/rd.mod.c \
...
drivers/block/rd.mod.o: $(deps_drivers/block/rd.mod.o)
