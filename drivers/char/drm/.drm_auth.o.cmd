cmd_drivers/char/drm/drm_auth.o := gcc -Wp,-MD,drivers/char/drm/.drm_auth.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow     -DMODULE -DKBUILD_BASENAME=drm_auth -DKBUILD_MODNAME=drm -c -o drivers/char/drm/.tmp_drm_auth.o drivers/char/drm/drm_auth.c

deps_drivers/char/drm/drm_auth.o := \
...
drivers/char/drm/drm_auth.o: $(deps_drivers/char/drm/drm_auth.o)
