cmd_drivers/char/drm/radeon_state.o := gcc -Wp,-MD,drivers/char/drm/.radeon_state.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow     -DMODULE -DKBUILD_BASENAME=radeon_state -DKBUILD_MODNAME=radeon -c -o drivers/char/drm/.tmp_radeon_state.o drivers/char/drm/radeon_state.c

deps_drivers/char/drm/radeon_state.o := \
...
drivers/char/drm/radeon_state.o: $(deps_drivers/char/drm/radeon_state.o)
