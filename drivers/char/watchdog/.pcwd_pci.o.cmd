cmd_drivers/char/watchdog/pcwd_pci.o := gcc -Wp,-MD,drivers/char/watchdog/.pcwd_pci.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow     -DMODULE -DKBUILD_BASENAME=pcwd_pci -DKBUILD_MODNAME=pcwd_pci -c -o drivers/char/watchdog/.tmp_pcwd_pci.o drivers/char/watchdog/pcwd_pci.c

deps_drivers/char/watchdog/pcwd_pci.o := \
...
drivers/char/watchdog/pcwd_pci.o: $(deps_drivers/char/watchdog/pcwd_pci.o)
