cmd_drivers/md/kcopyd.o := gcc -Wp,-MD,drivers/md/.kcopyd.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow      -DKBUILD_BASENAME=kcopyd -DKBUILD_MODNAME=dm_mod -c -o drivers/md/.tmp_kcopyd.o drivers/md/kcopyd.c

deps_drivers/md/kcopyd.o := \
  drivers/md/kcopyd.c \
...
drivers/md/kcopyd.o: $(deps_drivers/md/kcopyd.o)
