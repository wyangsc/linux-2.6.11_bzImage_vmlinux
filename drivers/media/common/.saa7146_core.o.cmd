cmd_drivers/media/common/saa7146_core.o := gcc -Wp,-MD,drivers/media/common/.saa7146_core.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow     -DMODULE -DKBUILD_BASENAME=saa7146_core -DKBUILD_MODNAME=saa7146 -c -o drivers/media/common/.tmp_saa7146_core.o drivers/media/common/saa7146_core.c

deps_drivers/media/common/saa7146_core.o := \
...
drivers/media/common/saa7146_core.o: $(deps_drivers/media/common/saa7146_core.o)
