cmd_drivers/mmc/mmc_queue.o := gcc -Wp,-MD,drivers/mmc/.mmc_queue.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow     -DMODULE -DKBUILD_BASENAME=mmc_queue -DKBUILD_MODNAME=mmc_core -c -o drivers/mmc/.tmp_mmc_queue.o drivers/mmc/mmc_queue.c
