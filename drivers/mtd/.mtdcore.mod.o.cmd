cmd_drivers/mtd/mtdcore.mod.o := gcc -Wp,-MD,drivers/mtd/.mtdcore.mod.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow      -DKBUILD_BASENAME=mtdcore -DKBUILD_MODNAME=mtdcore -DMODULE -c -o drivers/mtd/mtdcore.mod.o drivers/mtd/mtdcore.mod.c

deps_drivers/mtd/mtdcore.mod.o := \
  drivers/mtd/mtdcore.mod.c \
...
drivers/mtd/mtdcore.mod.o: $(deps_drivers/mtd/mtdcore.mod.o)
