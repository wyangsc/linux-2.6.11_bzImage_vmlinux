cmd_drivers/net/dl2k.mod.o := gcc -Wp,-MD,drivers/net/.dl2k.mod.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow      -DKBUILD_BASENAME=dl2k -DKBUILD_MODNAME=dl2k -DMODULE -c -o drivers/net/dl2k.mod.o drivers/net/dl2k.mod.c

deps_drivers/net/dl2k.mod.o := \
  drivers/net/dl2k.mod.c \
...
drivers/net/dl2k.mod.o: $(deps_drivers/net/dl2k.mod.o)
