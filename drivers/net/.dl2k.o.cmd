cmd_drivers/net/dl2k.o := gcc -Wp,-MD,drivers/net/.dl2k.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow     -DMODULE -DKBUILD_BASENAME=dl2k -DKBUILD_MODNAME=dl2k -c -o drivers/net/.tmp_dl2k.o drivers/net/dl2k.c

deps_drivers/net/dl2k.o := \
  drivers/net/dl2k.c \
  drivers/net/dl2k.h \
...
drivers/net/dl2k.o: $(deps_drivers/net/dl2k.o)
