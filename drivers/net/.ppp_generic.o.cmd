cmd_drivers/net/ppp_generic.o := gcc -Wp,-MD,drivers/net/.ppp_generic.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow     -DMODULE -DKBUILD_BASENAME=ppp_generic -DKBUILD_MODNAME=ppp_generic -c -o drivers/net/.tmp_ppp_generic.o drivers/net/ppp_generic.c
