cmd_drivers/net/s2io.mod.o := gcc -Wp,-MD,drivers/net/.s2io.mod.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow      -DKBUILD_BASENAME=s2io -DKBUILD_MODNAME=s2io -DMODULE -c -o drivers/net/s2io.mod.o drivers/net/s2io.mod.c

deps_drivers/net/s2io.mod.o := \
  drivers/net/s2io.mod.c \
...
drivers/net/s2io.mod.o: $(deps_drivers/net/s2io.mod.o)
