cmd_drivers/net/s2io.o := gcc -Wp,-MD,drivers/net/.s2io.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow     -DMODULE -DKBUILD_BASENAME=s2io -DKBUILD_MODNAME=s2io -c -o drivers/net/.tmp_s2io.o drivers/net/s2io.c

deps_drivers/net/s2io.o := \
  drivers/net/s2io.c \
    $(wildcard include/config/s2io/napi.h) \
    $(wildcard include/config/2buff/mode.h) \
...
drivers/net/s2io.o: $(deps_drivers/net/s2io.o)
