cmd_drivers/net/slip.mod.o := gcc -Wp,-MD,drivers/net/.slip.mod.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow      -DKBUILD_BASENAME=slip -DKBUILD_MODNAME=slip -DMODULE -c -o drivers/net/slip.mod.o drivers/net/slip.mod.c

deps_drivers/net/slip.mod.o := \
  drivers/net/slip.mod.c \
...
drivers/net/slip.mod.o: $(deps_drivers/net/slip.mod.o)
