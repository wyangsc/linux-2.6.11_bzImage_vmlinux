cmd_drivers/net/tg3.mod.o := gcc -Wp,-MD,drivers/net/.tg3.mod.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow      -DKBUILD_BASENAME=tg3 -DKBUILD_MODNAME=tg3 -DMODULE -c -o drivers/net/tg3.mod.o drivers/net/tg3.mod.c

deps_drivers/net/tg3.mod.o := \
  drivers/net/tg3.mod.c \
...
drivers/net/tg3.mod.o: $(deps_drivers/net/tg3.mod.o)
