cmd_drivers/net/irda/sir_kthread.o := gcc -Wp,-MD,drivers/net/irda/.sir_kthread.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow     -DMODULE -DKBUILD_BASENAME=sir_kthread -DKBUILD_MODNAME=sir_dev -c -o drivers/net/irda/.tmp_sir_kthread.o drivers/net/irda/sir_kthread.c

deps_drivers/net/irda/sir_kthread.o := \
...
drivers/net/irda/sir_kthread.o: $(deps_drivers/net/irda/sir_kthread.o)
