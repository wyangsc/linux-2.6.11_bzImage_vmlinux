cmd_drivers/net/ixgb/ixgb_ee.o := gcc -Wp,-MD,drivers/net/ixgb/.ixgb_ee.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow     -DMODULE -DKBUILD_BASENAME=ixgb_ee -DKBUILD_MODNAME=ixgb -c -o drivers/net/ixgb/.tmp_ixgb_ee.o drivers/net/ixgb/ixgb_ee.c

deps_drivers/net/ixgb/ixgb_ee.o := \
...
drivers/net/ixgb/ixgb_ee.o: $(deps_drivers/net/ixgb/ixgb_ee.o)
