cmd_drivers/serial/serial_cs.o := gcc -Wp,-MD,drivers/serial/.serial_cs.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow     -DMODULE -DKBUILD_BASENAME=serial_cs -DKBUILD_MODNAME=serial_cs -c -o drivers/serial/.tmp_serial_cs.o drivers/serial/serial_cs.c

deps_drivers/serial/serial_cs.o := \
...
drivers/serial/serial_cs.o: $(deps_drivers/serial/serial_cs.o)
