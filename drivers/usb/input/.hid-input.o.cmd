cmd_drivers/usb/input/hid-input.o := gcc -Wp,-MD,drivers/usb/input/.hid-input.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow      -DKBUILD_BASENAME=hid_input -DKBUILD_MODNAME=usbhid -c -o drivers/usb/input/.tmp_hid-input.o drivers/usb/input/hid-input.c
