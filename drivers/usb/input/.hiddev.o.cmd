cmd_drivers/usb/input/hiddev.o := gcc -Wp,-MD,drivers/usb/input/.hiddev.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow      -DKBUILD_BASENAME=hiddev -DKBUILD_MODNAME=usbhid -c -o drivers/usb/input/.tmp_hiddev.o drivers/usb/input/hiddev.c
