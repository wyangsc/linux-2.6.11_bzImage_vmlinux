cmd_drivers/usb/net/kaweth.o := gcc -Wp,-MD,drivers/usb/net/.kaweth.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow     -DMODULE -DKBUILD_BASENAME=kaweth -DKBUILD_MODNAME=kaweth -c -o drivers/usb/net/.tmp_kaweth.o drivers/usb/net/kaweth.c

deps_drivers/usb/net/kaweth.o := \
...
drivers/usb/net/kaweth.o: $(deps_drivers/usb/net/kaweth.o)
