cmd_drivers/usb/net/pegasus.o := gcc -Wp,-MD,drivers/usb/net/.pegasus.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow     -DMODULE -DKBUILD_BASENAME=pegasus -DKBUILD_MODNAME=pegasus -c -o drivers/usb/net/.tmp_pegasus.o drivers/usb/net/pegasus.c

deps_drivers/usb/net/pegasus.o := \
...
drivers/usb/net/pegasus.o: $(deps_drivers/usb/net/pegasus.o)
