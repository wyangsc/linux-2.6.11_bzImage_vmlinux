cmd_fs/ext2/xattr_trusted.o := gcc -Wp,-MD,fs/ext2/.xattr_trusted.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow      -DKBUILD_BASENAME=xattr_trusted -DKBUILD_MODNAME=ext2 -c -o fs/ext2/.tmp_xattr_trusted.o fs/ext2/xattr_trusted.c
