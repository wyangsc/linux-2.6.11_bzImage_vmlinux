cmd_fs/ufs/symlink.o := gcc -Wp,-MD,fs/ufs/.symlink.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow     -DMODULE -DKBUILD_BASENAME=symlink -DKBUILD_MODNAME=ufs -c -o fs/ufs/.tmp_symlink.o fs/ufs/symlink.c

deps_fs/ufs/symlink.o := \
  fs/ufs/symlink.c \
  include/linux/fs.h \
...
fs/ufs/symlink.o: $(deps_fs/ufs/symlink.o)
