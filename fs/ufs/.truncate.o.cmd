cmd_fs/ufs/truncate.o := gcc -Wp,-MD,fs/ufs/.truncate.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow     -DMODULE -DKBUILD_BASENAME=truncate -DKBUILD_MODNAME=ufs -c -o fs/ufs/.tmp_truncate.o fs/ufs/truncate.c

deps_fs/ufs/truncate.o := \
  fs/ufs/truncate.c \
...
fs/ufs/truncate.o: $(deps_fs/ufs/truncate.o)
