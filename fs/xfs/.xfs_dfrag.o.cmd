cmd_fs/xfs/xfs_dfrag.o := gcc -Wp,-MD,fs/xfs/.xfs_dfrag.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow   -Ifs/xfs -Ifs/xfs/linux-2.6 -funsigned-char  -DMODULE -DKBUILD_BASENAME=xfs_dfrag -DKBUILD_MODNAME=xfs -c -o fs/xfs/.tmp_xfs_dfrag.o fs/xfs/xfs_dfrag.c
