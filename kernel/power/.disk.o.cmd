cmd_kernel/power/disk.o := gcc -Wp,-MD,kernel/power/.disk.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow   -DDEBUG   -DKBUILD_BASENAME=disk -DKBUILD_MODNAME=disk -c -o kernel/power/.tmp_disk.o kernel/power/disk.c

deps_kernel/power/disk.o := \
  kernel/power/disk.c \
...
kernel/power/disk.o: $(deps_kernel/power/disk.o)
