cmd_kernel/power/pm.o := gcc -Wp,-MD,kernel/power/.pm.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow   -DDEBUG   -DKBUILD_BASENAME=pm -DKBUILD_MODNAME=pm -c -o kernel/power/.tmp_pm.o kernel/power/pm.c

deps_kernel/power/pm.o := \
  kernel/power/pm.c \
...
kernel/power/pm.o: $(deps_kernel/power/pm.o)
