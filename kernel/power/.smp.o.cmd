cmd_kernel/power/smp.o := gcc -Wp,-MD,kernel/power/.smp.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow   -DDEBUG   -DKBUILD_BASENAME=smp -DKBUILD_MODNAME=smp -c -o kernel/power/.tmp_smp.o kernel/power/smp.c

deps_kernel/power/smp.o := \
  kernel/power/smp.c \
...
kernel/power/smp.o: $(deps_kernel/power/smp.o)
