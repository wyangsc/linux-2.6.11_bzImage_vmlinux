cmd_net/bridge/br_netfilter.o := gcc -Wp,-MD,net/bridge/.br_netfilter.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow     -DMODULE -DKBUILD_BASENAME=br_netfilter -DKBUILD_MODNAME=bridge -c -o net/bridge/.tmp_br_netfilter.o net/bridge/br_netfilter.c
