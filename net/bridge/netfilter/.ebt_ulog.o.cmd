cmd_net/bridge/netfilter/ebt_ulog.o := gcc -Wp,-MD,net/bridge/netfilter/.ebt_ulog.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow     -DMODULE -DKBUILD_BASENAME=ebt_ulog -DKBUILD_MODNAME=ebt_ulog -c -o net/bridge/netfilter/.tmp_ebt_ulog.o net/bridge/netfilter/ebt_ulog.c

deps_net/bridge/netfilter/ebt_ulog.o := \
...
net/bridge/netfilter/ebt_ulog.o: $(deps_net/bridge/netfilter/ebt_ulog.o)
