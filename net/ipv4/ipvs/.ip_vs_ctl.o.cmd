cmd_net/ipv4/ipvs/ip_vs_ctl.o := gcc -Wp,-MD,net/ipv4/ipvs/.ip_vs_ctl.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow     -DMODULE -DKBUILD_BASENAME=ip_vs_ctl -DKBUILD_MODNAME=ip_vs -c -o net/ipv4/ipvs/.tmp_ip_vs_ctl.o net/ipv4/ipvs/ip_vs_ctl.c

deps_net/ipv4/ipvs/ip_vs_ctl.o := \
...
net/ipv4/ipvs/ip_vs_ctl.o: $(deps_net/ipv4/ipvs/ip_vs_ctl.o)
