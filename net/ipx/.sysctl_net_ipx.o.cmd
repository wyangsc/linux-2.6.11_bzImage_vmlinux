cmd_net/ipx/sysctl_net_ipx.o := gcc -Wp,-MD,net/ipx/.sysctl_net_ipx.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow     -DMODULE -DKBUILD_BASENAME=sysctl_net_ipx -DKBUILD_MODNAME=ipx -c -o net/ipx/.tmp_sysctl_net_ipx.o net/ipx/sysctl_net_ipx.c
