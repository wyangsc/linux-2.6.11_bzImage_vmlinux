cmd_sound/pci/ac97/ac97_patch.o := gcc -Wp,-MD,sound/pci/ac97/.ac97_patch.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow     -DMODULE -DKBUILD_BASENAME=ac97_patch -DKBUILD_MODNAME=snd_ac97_codec -c -o sound/pci/ac97/.tmp_ac97_patch.o sound/pci/ac97/ac97_patch.c

deps_sound/pci/ac97/ac97_patch.o := \
...
sound/pci/ac97/ac97_patch.o: $(deps_sound/pci/ac97/ac97_patch.o)
