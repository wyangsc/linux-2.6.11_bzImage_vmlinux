...
__attribute__((section("__versions"))) = {
	...
	{ 0x66d902da, "snd_ac97_write_cache" },
...
"depends=snd,snd-ac97-codec,snd-pcm,snd-mpu401-uart,snd-ice17xx-ak4xxx,snd-ak4xxx-adda";

MODULE_ALIAS("pci:v00001412d00001724sv*sd*bc*sc*i*");

MODULE_INFO(srcversion, "F7E45AB9F6C9FAD742FDB40");
