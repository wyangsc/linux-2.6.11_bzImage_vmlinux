cmd_sound/pci/trident/trident_synth.o := gcc -Wp,-MD,sound/pci/trident/.trident_synth.o.d -nostdinc -isystem /usr/lib/gcc-lib/x86_64-linux/3.3.5/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g  -mno-red-zone -mcmodel=kernel -pipe -fno-reorder-blocks	 -Wno-sign-compare  -mno-sse -mno-mmx -mno-sse2 -mno-3dnow     -DMODULE -DKBUILD_BASENAME=trident_synth -DKBUILD_MODNAME=snd_trident_synth -c -o sound/pci/trident/.tmp_trident_synth.o sound/pci/trident/trident_synth.c

deps_sound/pci/trident/trident_synth.o := \
...
sound/pci/trident/trident_synth.o: $(deps_sound/pci/trident/trident_synth.o)
